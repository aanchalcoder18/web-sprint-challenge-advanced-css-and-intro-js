...
let first = artists[0].name;
console.log(first);

//(2) Bio of the third artist (2nd index) in the array 
let second = artists[2].bio;
console.log(second);
...
console.log(addArtist(artists,'20', 'Aanchal', '1997-2021', 'Full Stack', 'Indian', 'My hobbies are swimming, reading, and watching marvel movies'));
